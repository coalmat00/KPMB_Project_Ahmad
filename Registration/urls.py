...
urlpatterns = [
    ...
    path(
        "update_course/save_update_course/<str:code>",
        views.save_update_course,
        name="save_update_course",
    ),
    path("search_by_course", views.search_by_course, name="search_by_course"),
]


# update   views and urls setiap kali update page baru.
# apa2 data yg nak dipass ke html kena dlm dictionary.
